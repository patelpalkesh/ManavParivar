...
return [
    ...
    */
    ...
    'additional_js' => [
        ...
        'https://cdn.datatables.net/buttons/1.6.4/js/buttons.bootstrap.min.js',
        'https://cdn.datatables.net/buttons/1.6.4/js/buttons.html5.min.js',
        'https://cdn.datatables.net/buttons/1.6.4/js/buttons.print.min.js',
